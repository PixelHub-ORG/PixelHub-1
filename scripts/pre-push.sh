...
# ============================================================================
# Pre-push Hook - Formateo y Linting Automático
# ============================================================================
# Este script se ejecuta antes de cada push y:
...
if [ -n "$CHANGED_FILES" ]; then
    ...
    if [ -n "$(git diff --cached --name-only)" ]; then
        ...
        echo "   El push continuará con este commit adicional."
    else
...
echo "🚀 Push permitido. Continuando..."
echo ""
