...
try:
    ...
    from importlib_metadata import (  # fallback para Python <3.8
...
def decode_lyrics(encoded_lyrics):
    decoded_lyrics = base64.b64decode(
        encoded_lyrics.encode("utf-8")).decode("utf-8")
